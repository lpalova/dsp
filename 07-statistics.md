...
P(twin) = P(fraternal twin) OR P(identical twin) = P(fraternal twin) + P(identical twin) = 1/125 + 1/300  
P(identical twin | twin) = ?  

P(identical twin | twin) = P(identical twin AND twin) / P(twin) = P(identical twin) / P(twin) = (1/300)/(1/125+1/300) = 5/17   
